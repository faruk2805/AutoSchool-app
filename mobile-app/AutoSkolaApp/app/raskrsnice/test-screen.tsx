...
export default function RaskrsniceTestScreen() {
  ...
  const [timeLeft, setTimeLeft] = useState(1800); // 30 minuta
  ...
  const loadUserAndQuestions = async () => {
    try {
      ...
      Alert.alert("Greška", "Došlo je do greške pri učitavanju testa raskrsnica");
      router.back();
    } finally {
      setIsLoading(false);
    }
  ...
  const handleTimeUp = () => {
    Alert.alert(
      "Vrijeme je isteklo!",
      "Test raskrsnica je automatski završen zbog isteka vremena.",
  ...
  const calculateResults = () => {
    ...
    const passed = score >= 85; // Veći prag za raskrsnice
    ...
    Alert.alert(
      ...
      [
        { text: "Povratak", onPress: () => router.push("/raskrsnice") },
  ...
  const showDetailedResults = (result: TestResult) => {
    router.push({
      pathname: "/raskrsnice/pregled-rezultata",
      params: {
  ...
  if (isLoading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Učitavam test raskrsnica...</Text>
      </View>
    );
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Test Raskrsnica</Text>
        </View>
        <View style={styles.content}>
          <Text style={styles.noQuestionsText}>Nema dostupnih pitanja za test raskrsnica.</Text>
        </View>
      </View>
    );
  }
            ...
            <View style={styles.imageContainer}>
              {imageLoading[currentQuestion._id] && (
                <View style={styles.imagePlaceholder}>
                  ...
                  <Text style={styles.imageLoadingText}>Učitavam scenarij...</Text>
                </View>
              )}
              <Image
                source={{ uri: imageUrl }}
                style={styles.raskrsnicaImage}
                resizeMode="contain"
            ...
            <View style={styles.modalHeader}>
              <View style={styles.modalIconContainer}>
                <View style={styles.modalIconCircle}>
                  <Ionicons name="traffic-light" size={32} color="#E74C3C" />
                </View>
              </View>
              <View style={styles.modalTitleContainer}>
                <Text style={styles.modalTitle}>Objašnjenje Raskrsnice</Text>
