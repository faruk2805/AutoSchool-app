...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (data.token) {
        ...
        // 🔹 KLJUČNA ISPRAVKA: SPREMANJE POD OBA FORMATA
        ...
        console.log('✅ Verified - Token:', !!savedToken, 'User object:', !!savedUser);
  ...
  const handleForgotPassword = () => {
    Alert.alert(
      "Reset lozinke", 
      "Pošaljite email na: support@unaschool.hr"
    );
  };
  ...
  const handleRegisterRedirect = () => {
    Alert.alert(
      "Registracija", 
      "Za registraciju novog korisnika kontaktirajte administraciju na:\n\nadmin@unaschool.hr"
    );
  };
      ...
      >
        ...
        {showLoginForm && (
          <Animated.View style={[
            ...
            <Text style={styles.instructionText}>Unesite svoje korisničke podatke</Text>

            {/* Email Input */}
            <View style={styles.inputContainer}>
              <Ionicons name="mail-outline" size={20} color="#2086F6" style={styles.inputIcon} />
              <TextInput
                style={styles.input}
            ...
            {/* Password Input */}
            <View style={styles.inputContainer}>
              <Ionicons name="lock-closed-outline" size={20} color="#2086F6" style={styles.inputIcon} />
              <TextInput
                style={styles.input}
                placeholder="Lozinka"
                placeholderTextColor="#999"
        ...
        >
          <View style={styles.footerIcons}>
            ...
            <Text style={styles.footerSubText}>Sigurna i zaštićena prijava</Text>
          </View>
