...
export default function LekcijeZnakovi() {
  ...
  const loadProgressFromAPI = async (user_Id: string) => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/testresults/user/${user_Id}/znak/lekcijski`
      );
      
      console.log('🌐 API URL:', `${API_BASE_URL}/api/testresults/user/${user_Id}/znak/lekcijski`);
  ...
  const handleLessonSelect = (lessonNumber: number) => {
    ...
    router.push({
      pathname: `/saobracajni-znakovi/lekcija`,
      params: { 
        lesson: lessonNumber,
        userId: userId
      }
  ...
  const getLessonTitle = (lessonNumber: number) => {
    const titles = {
      ...
      2: 'Znakovi Zabrane',
      3: 'Znakovi Obaveze',
      4: 'Znakovi Obavještenja',
      5: 'Oblik i Boja Znakova',
      6: 'Pomoćni Znakovi',
  ...
  const getLessonDescription = (lessonNumber: number) => {
    const descriptions = {
      1: 'Upozorenja na opasnosti, trokutasti crveni obrub',
      2: 'Oblik kruga, crveni obrub, zabrane i ograničenja',
      3: 'Plavi krug, obavezne radnje i smjerovi',
      4: 'Pravougaoni, informacije i uputstva',
      5: 'Značenje oblika i boja saobraćajnih znakova',
      6: 'Dodatne table, vrijeme važenja, izuzeci',
      7: 'Oznake na kolovozu, signalne linije',
      8: 'Privremeni znakovi, radovi na putu'
    };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>Saobraćajni Znakovi</Text>
      ...
      >
        ...
        <View style={styles.lessonsSection}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Lekcije Saobraćajnih Znakova</Text>
            <Text style={styles.sectionSubtitle}>Prepoznavanje i razumijevanje znakova</Text>
          </View>
